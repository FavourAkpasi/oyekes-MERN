...
export const description = [
  {
    title: "OYEKES Hair",
    desc: "With a history stretching back over 10 years, the brand’s Hair Quality have become key for Fashion Enthusiast Nationwide and it has an increasing growing Customerbase. For that fresh, Sleek, and comfortable Feel, filter through Oyekes Hair we have  everything you need from human hair to peruvian and brasillain hair. Inspired by street culture and retro styles, Oyekes Originals brings those fresh, archive-inspired Hair Types we all know and love. Scroll through the OYEKES hair category to check out our favourites – if you’re not already.",
  },
  {
    title: "OYEKES Fabrics",
    desc: "With a history stretching back over 10 years, the brand’s Hair Quality and designs have become key for Fashion Enthusiast Nationwide and it has an increasing growing Customerbase. For that fresh, Sleek, and comfortable Feel, filter through Oyekes Hair we have  everything you need from human hair to peruvian and brasillain hair. Inspired by street culture and retro styles, Oyekes Originals brings those fresh, archive-inspired Hair Types we all know and love. Scroll through the OYEKES hair category to check out our favourites – if you’re not already.",
  },
];

export const superMegaArray = [
  {
    id: uuidv4(),
    name: "Straight Hair",
    image: "images/h1.jpg",
